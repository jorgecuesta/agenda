 ...
 */
const every = function (interval, names, data, options, session) {
    return __awaiter(this, void 0, void 0, function* () {
         ...
         */
        const createJob = (interval, name, data, options, session) => __awaiter(this, void 0, void 0, function* () {
         ...
         */
        const createJobs = (interval, names, data, options, session) => __awaiter(this, void 0, void 0, function* () {
            try {
                const jobs = [];
        ...
        if (typeof names === "string") {
            ...
            const jobs = yield createJob(interval, names, data, options, session);
            return jobs;
        }
        if (Array.isArray(names)) {
            debug("Agenda.every(%s, %s, %O)", interval, names, options);
            const jobs = yield createJobs(interval, names, data, options, session);
            return jobs;
        }
    });
};
