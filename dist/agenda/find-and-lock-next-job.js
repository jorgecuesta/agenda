 ...
 */
const findAndLockNextJob = function (jobName, definition, session) {
    return __awaiter(this, void 0, void 0, function* () {
         ...
         */
        const JOB_RETURN_QUERY = { returnDocument: mongodb_1.ReturnDocument.AFTER, sort: this._sort, session };
