...
declare class Agenda extends EventEmitter {
    ...
    _definitions: any;
    _findAndLockNextJob: (this: Agenda, jobName: string, definition: any, session?: import("mongodb").ClientSession | undefined) => Promise<Job<import("../job").JobAttributesData> | undefined>;
    _indices: any;
