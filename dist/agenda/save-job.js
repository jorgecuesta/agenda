 ...
 * @access private
 */
const processDbResult = function (job, result, session) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (resultValue) {
            ...
            if (result.insertedId) {
                ...
                const _job = yield this._collection.findOne({ _id }, { session });
                if (_job) {
 ...
 */
const saveJob = function (job, session) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (id) {
                ...
                const result = yield this._collection.findOneAndUpdate({ _id: id }, update, { returnDocument: "after", session });
            ...
            const result = yield this._collection.insertOne(props, { session });
            return yield processDbResult.call(this, job, result);
        }
        catch (error) {
