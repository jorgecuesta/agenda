...
function schedule(when, names, data, session) {
    /**
     ...
     */
    const createJob = (when, name, data, session) => __awaiter(this, void 0, void 0, function* () {
        const job = this.create(name, data);
        yield job.schedule(when).save(session);
        return job;
    });
    /**
     ...
     */
    const createJobs = (when, names, data, session) => __awaiter(this, void 0, void 0, function* () {
        try {
            const createJobList = [];
