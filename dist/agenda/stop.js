...
const stop = function (session) {
    return __awaiter(this, void 0, void 0, function* () {
         ...
         * @returns resolves when job unlocking fails or passes
         */
        const _unlockJobs = (session) => __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => {
                ...
                this._collection.updateMany({ _id: { $in: jobIds } }, { $set: { lockedAt: null } }, { session }, (error) => {
                    if (error) {
                        reject(error);
                    }
                    this._lockedJobs = [];
